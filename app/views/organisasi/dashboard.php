    ...
    <div class="sidebar">
        ...
        <div class="org-info text-center mb-3" style="padding: 0 20px;">
            <div class="org-avatar mb-2"
                style="width: 50px; height: 50px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto; color: white; font-weight: bold;">
                <?= $org_initials ?>
            </div>
        ...
        <nav class="nav flex-column">
            ...
            <a href="<?= BASE_URL ?>organisasi/llm-dashboard"
                class="nav-link <?= $current_page === 'ai-recommendations' ? 'active' : '' ?>">
        ...
        <!-- Footer -->
        <div
            style="position: absolute; bottom: 20px; left: 20px; right: 20px; text-align: center; color: rgba(255,255,255,0.6); font-size: 11px;">
            ...
            <div class="left-column">
                ...
                <div class="shortcut-section">
                    ...
                    <div class="shortcut-buttons">
                        <button type="button" class="shortcut-btn" data-bs-toggle="modal"
                ...
                <div class="events-list">
                    <?php if (empty($active_events)): ?>
                        ...
                        <div class="empty-state">
                            ...
                            <p>Organisasi Anda belum memiliki event aktif. Mulai buat event pertama untuk melihat aktivitas
                                di sini.</p>
                            <button type="button" class="btn-create-first" data-bs-toggle="modal"
                                data-bs-target="#createEventModal">
                            ...
                            <div class="event-item">
                                ...
                                <?php if (!empty($event['poster'])): ?>
                                    <div class="event-poster mb-2">
                                        <img src="<?= BASE_URL ?>uploads/posters/<?= $event['poster'] ?>" alt="Poster"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="kapasitas" name="kapasitas" min="1"
                                    max="10000" placeholder="100" required>
                            </div>
                        </div>
